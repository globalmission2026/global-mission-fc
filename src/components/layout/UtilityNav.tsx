export default function UtilityNav() {
  return (
    <div className="gmfci-utility-nav">
      <div className="gmfci-utility-nav__inner">
        <div className="gmfci-utility-nav__left">
          {/* Phone could go here */}
        </div>
        <div className="gmfci-utility-nav__right">
          <span className="gmfci-util-label">Follow us:</span>

          <a
            href="https://www.facebook.com/profile.php?id=61591907680791"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Facebook"
            className="gmfci-util-social"
          >
          ...
          <a
            href="https://www.instagram.com/globalmissionfc/"
            target="_blank"
            rel="noopener noreferrer"
